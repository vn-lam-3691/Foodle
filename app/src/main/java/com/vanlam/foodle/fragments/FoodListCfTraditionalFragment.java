...
public class FoodListCfTraditionalFragment extends Fragment {
    private RecyclerView rcvFoodListCfTradition;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_food_list_cf_traditional, container, false);
        return rootView;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rcvFoodListCfTradition = (RecyclerView) rootView.findViewById(R.id.recyclerView_foodList_CfTradition);
        ...
        rcvFoodListCfTradition.setLayoutManager(staggeredGridLayoutManager);

        options = new FirebaseRecyclerOptions.Builder<Food>()
                .setQuery(reference.child("Product").orderByChild("idCategory").equalTo("0" + String.valueOf(1)), Food.class)
                .build();
        foodItemAdapter = new FoodItemAdapter(options);
        rcvFoodListCfTradition.setAdapter(foodItemAdapter);
    }
