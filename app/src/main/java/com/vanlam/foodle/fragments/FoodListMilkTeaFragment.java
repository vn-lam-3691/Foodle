...
public class FoodListMilkTeaFragment extends Fragment {
    private RecyclerView rcvFoodListMilkTea;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_food_list_milk_tea, container, false);
        return rootView;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rcvFoodListMilkTea = (RecyclerView) rootView.findViewById(R.id.recyclerView_foodList_milkTea);
        ...
        rcvFoodListMilkTea.setLayoutManager(staggeredGridLayoutManager);

        options = new FirebaseRecyclerOptions.Builder<Food>()
                .setQuery(reference.child("Product").orderByChild("idCategory").equalTo("0" + String.valueOf(4)), Food.class)
                .build();
        foodItemAdapter = new FoodItemAdapter(options);
        rcvFoodListMilkTea.setAdapter(foodItemAdapter);
    }
